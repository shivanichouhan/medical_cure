  ...
  function (_super) {
    ...
    Socket.prototype.start = function (id, token) {
      ...
      this._socket.onmessage = function (event) {
        var data;
        // working--
        // https://backend.xpresscure.com/peerjs/myapp/peerjs/id?ts=16206490619860.35918780327580246

        // not working
        // https://backend.xpresscure.com:5000/peerjs/myapp/peerjs/id?ts=16206490619860.35918780327580246
