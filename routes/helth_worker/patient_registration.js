...
const {appoinment_status,acceptedPatient_data, create,accepted_patient_list, patient_list, patient_verfiy, patient_info, search_patient, status_patient } = require("../../controller/helth_worker/patient_registration")
...
router.post("/patient/accepted_patient_list",accepted_patient_list)
router.post("/patient/acceptedPatient_data",acceptedPatient_data)
