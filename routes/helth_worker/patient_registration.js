...
const {appoinment_status, create,accepted_patient_list, patient_list, patient_verfiy, patient_info, search_patient, status_patient } = require("../../controller/helth_worker/patient_registration")
